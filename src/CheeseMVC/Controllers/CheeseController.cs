...
namespace CheeseMVC.Controllers
{
    public class CheeseController : Controller
    {
        ...
        public IActionResult Add(AddCheeseViewModel addCheeseViewModel)
        {
            ...
            //Fix: when returning view on error, category select list is not populated
            //return View(addCheeseViewModel);
        ...
        public IActionResult Category(int id)
        {
            ...
            //you could also ask for all the cheeses where the categoryID matches the id you passed in
            /* 
            ...
            */
            ...
            //The makes it easier to get the category name
